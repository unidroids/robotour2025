...
class FusionCore:
    def __init__(self, angle_window_size: int = 20):
        ...
        # --- posledni stav headingu ---
        self._global_heading: float = 0.0
        self._headingAcc: float = 180.0        # zatím konstanta – můžeme navázat na quality později
        ...
        # --- IMU ---
        self._local_heading: float = 0.0
        self._local_omega: float = 0.0   # [deg/s]
    ...
    def update_global_heading(self, iTow, heading, gstddev, lenght):
        ...
        #print(heading, self._heading, gstddev)
        self._global_heading = heading
        self._headingAcc = gstddev
    ...
    def update_local_heading(self, tmark, heading, omega):
        self._local_omega = omega
        self._local_heading = heading
        #pass
        # tmark = float(tmark)
    ...
    def get_solution(self) -> NavFusionData:
        ...
        heading = self._global_heading
        headingAcc = self._headingAcc

        local_omega  = self._local_omega
        local_heading = self._local_heading
        ...
        return NavFusionData(
            ...
            hAcc=hAcc,
            heading=heading,
            headingAcc=headingAcc,        # zatím konstanta – můžeme navázat na quality později
            speed=left_speed,
            sAcc=right_speed,
            gyroZ=local_omega,
            gyroZAcc=local_heading,
            gnssFixOK=False,
            drUsed=False,
        )